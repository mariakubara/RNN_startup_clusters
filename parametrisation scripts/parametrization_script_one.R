...
model <- keras_model_sequential() %>% 
  ...
  layer_simple_rnn(units = FLAGS$nodes2, return_sequences = T, dropout = FLAGS$dropout2) %>%
  layer_simple_rnn(units = FLAGS$nodes3, return_sequences = F, dropout = FLAGS$dropout3) %>%
